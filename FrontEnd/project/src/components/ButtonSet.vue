<template lang="html">
  <div class="">
    <div class="ball-set">
            ...
            <router-link :to="{ path: '/' }">
    					<svg class="center"style="width:36px;height:36px" viewBox="0 0 24 24">
                <path fill="#ffffff" fill-rule="evenodd" d="M17.8913288,10 L11.8900003,3.99867157 L5.88867192,10 L5.89001465,10 L5.89001465,20 L17.8900146,20 L17.8900146,10 L17.8913288,10 Z M19.8900146,11.9986859 L19.8900146,20 C19.8900146,21.1045695 18.9945841,22 17.8900146,22 L5.89001465,22 C4.78544515,22 3.89001465,21.1045695 3.89001465,20 L3.89001465,11.9986573 L2.41319817,13.4754737 L1,12.0622756 L10.4769858,2.5852898 C11.2573722,1.8049034 12.5226285,1.8049034 13.3030149,2.5852898 L22.7800007,12.0622756 L21.3668025,13.4754737 L19.8900146,11.9986859 Z"/>
    					</svg>
            </router-link >
  				</div>
  			</div>
...
<style scoped>
  ...
  .fly:nth-of-type(5)>.ball{
  	opacity: 1;
  	background-color: #9932CC;
  	box-shadow: 5px 5px  7px 0 rgba(0,0,0,.3);
  }
  .fly:nth-of-type(4)>.ball{
  	background-color: #FF4500;
  }
  .fly:nth-of-type(3)>.ball{

  	background-color: #32CD32;

  }
  .fly:nth-of-type(2)>.ball{
  	background-color: #8470FF;
  }

  .fly-show:nth-of-type(5){
  	bottom:40px;
  ...
  .fly-show:nth-of-type(4){
  	bottom:110px;

  	opacity: 1;
  }
  .fly-show:nth-of-type(3){
  	bottom:180px;

  	opacity: 1;
  }
  .fly-show:nth-of-type(2){
  	bottom:250px;
